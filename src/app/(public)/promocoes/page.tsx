  ...
  return (
    <>
      ...
      <section className="racing-clip relative overflow-hidden bg-boost text-white">
        ...
        <Container className="relative py-12 pb-20 sm:py-16 sm:pb-24 lg:py-20 lg:pb-28">
          ...
          <h1 className="mt-4 text-balance font-display text-3xl font-bold uppercase leading-[0.95] tracking-tight sm:text-4xl lg:text-6xl">
            Promoções
          </h1>
